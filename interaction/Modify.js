...
var Modify = /** @class */ (function (_super) {
    ...
    Modify.prototype.willModifyFeatures_ = function (evt, segments) {
        if (!this.featuresBeingModified_) {
            ...
            var features = this.featuresBeingModified_;
            ...
            this.dispatchEvent(new ModifyEvent(ModifyEventType.MODIFYSTART, new Collection(features), evt));
        }
    };
    /**
     * @param {Feature} feature Feature.
    ...
    Modify.prototype.handleUpEvent = function (evt) {
        ...
        if (this.featuresBeingModified_) {
            this.dispatchEvent(new ModifyEvent(ModifyEventType.MODIFYEND, new Collection(this.featuresBeingModified_), evt));
            this.featuresBeingModified_ = null;
        }
        return false;
    };
    ...
    Modify.prototype.handlePointerAtPixel_ = function (pixel, map, opt_coordinate) {
        ...
        if (this.layer_) {
            map.forEachFeatureAtPixel(pixel, function (feature, layer, geometry) {
                ...
                layerFilter: function (layer) { return layer === _this.layer_; },
            });
        }
        if (!box) {
            ...
            box = toUserExtent(bufferExtent(viewExtent, buffer, tempExtent), projection);
        }
